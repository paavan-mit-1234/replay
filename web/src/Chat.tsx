...
export default function Chat() {
  ...
  async function send() {
    ...
    try {
      ...
      setMessages(d.messages)
      loadConvs()
      // The title is generated by a background task; refresh once it lands.
      window.setTimeout(() => loadConvs(), 2800)
      findSimilar(content)
      ...
      <section className="chat-main">
        ...
        <div className="composer">
          ...
          <div className="composer-actions">
            <select
              className="input"
              style={{ width: 'auto', padding: '6px 28px 6px 10px', marginRight: 'auto' }}
              value={model}
